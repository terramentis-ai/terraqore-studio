...
"""
            for achievement in achievements:
                md += f"- {achievement.get('icon', '⭐')} **{achievement.get('badge_name', 'Unknown')}** - {achievement.get('description', '')}\n"
            md += "\n"
...
*Export generated by FlyntCore v1.0 on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}*  
[FlyntCore Documentation](https://github.com/FlyntCore)
"""
...
<head>
    ...
    <title>FlyntCore Project Export: {project_data.get('name', 'Unknown')}</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <h1>🎯 {project_data.get('name', 'Unknown Project')}</h1>
...
"""
            for achievement in achievements:
                ...
                <div class="achievement-icon">{achievement.get('icon', '⭐')}</div>
...
"""
        ...
        html += f"""        <footer>
            <p>Generated by <strong>FlyntCore v1.0</strong> on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}</p>
            <p><a href="https://github.com/FlyntCore">FlyntCore Documentation</a></p>
        </footer>
    </div>
</body>
</html>
